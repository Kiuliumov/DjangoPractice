    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surface_type', models.CharField(choices=[('Not Selected', 'Na'), ('Clay', 'Clay'), ('Grass', 'Grass'), ('Hard Court', 'Hard Court')], default='Not Selected', max_length=12)),
            ],
        ),
        migrations.CreateModel(
            name='Match',
            fields=[
                ...
                ('winner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='winning_matches', to='main_app.tennisplayer')),
